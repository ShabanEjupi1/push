...
@Entity
@Table(name="WHS_UNDECLARED_STOCK", schema="KCUSTOMS")
public class UndeclaredStock
...
Displayable {
    ...
    @Column(name="REG_EXIT_NWGT")
    private BigDecimal registeredExitNetWeight;
    @Column(name="REG_EXIT_QTY")
    private BigDecimal registeredExitQuantity;
    ...
    public BigDecimal getRegisteredExitNetWeight() {
        return this.registeredExitNetWeight;
    }

    public void setRegisteredExitNetWeight(BigDecimal registeredExitNetWeight) {
        this.registeredExitNetWeight = registeredExitNetWeight;
    }

    public BigDecimal getRegisteredExitQuantity() {
        return this.registeredExitQuantity;
    }

    public void setRegisteredExitQuantity(BigDecimal registeredExitQuantity) {
        this.registeredExitQuantity = registeredExitQuantity;
    }
    ...
    public boolean equals(Object obj) {
        ...
        UndeclaredStock other = (UndeclaredStock)obj;
